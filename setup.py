...
setuptools.setup(
    ...
    url='https://github.com/korney3/emotion_classifier',
    project_urls={
        "Bug Tracker": "https://github.com/korney3/emotion_classifier/issues"
    },
    license='MIT',
    packages=setuptools.find_packages(),
    package_data={'data_science_module': ['./models/*.yml']},
